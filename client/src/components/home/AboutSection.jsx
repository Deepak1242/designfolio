  ...
  return (
    <section id="about" ref={sectionRef} className="min-h-screen py-20 px-6 md:px-20 bg-gallery-bg text-gallery-text relative overflow-visible z-10">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-20 items-center">
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[80%] bg-accent-acid/20 -z-10 rotate-12 blur-xl rounded-full" />
          </div>

          <div className="w-full md:w-1/2 relative">
            <span className="absolute -top-12 -left-8 text-7xl md:text-9xl font-display font-bold text-gray-100 -z-10 select-none">AGENCY</span>

            <h2 className="text-sm font-mono font-bold tracking-[0.3em] uppercase mb-8 border-b-4 border-accent-orange pb-2 inline-block bg-accent-orange/10 px-4 transform -skew-x-12">Nextruss Designs</h2>

            <p ref={textRef} className="text-4xl md:text-6xl font-display font-bold leading-[0.9] mb-8 text-gallery-text">
              Digital <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-acid to-accent-orange italic font-serif">Agency</span> obsessed with crafting <span className="underline decoration-wavy decoration-accent-acid underline-offset-8">functional art</span>.
            </p>
            ...
            <div className="grid grid-cols-2 gap-8 mb-12">
              <div className="space-y-2 border-l-4 border-accent-acid pl-4">
      ...
      <div className="absolute bottom-10 left-10 hidden md:block z-0 opacity-50">
        <RotatingBadge text="CREATIVE • DEV • ART • " className="text-accent-acid" />
      </div>
